...
<body style="background-image: url(/image/adminback.jpg)";> 
    <div id="app">
        <nav class="navbar navbar-default navbar-static-top">
            <div  class="col-md-1">
                    <br>
                   <a href="/locale/fa"><img src="/image/afgflag.gif" height="20px" width="30px"> Spanish</a><br>
...
s
    ...
    <span style="float:left; margin:10px"><i class="fa fa-copyright" aria-hidden="true"></i>Created MaG - 2020 </span>
    </div>
